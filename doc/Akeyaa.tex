...
\end{equation}
%
For $x > 7$ the absolute error is less than $0.02$ and the relative error is less than $2.6 \times 10^{-14}$.

Substituting \eqref{8.9} into \eqref{8.1} yields
%
\begin{equation}\label{8.10}
    f\left( \theta | \mat{u}, \mat{V} \right)
    \approx \left( \frac{1}{AD} \right) \cdot \sqrt{2\pi} \cdot E \cdot \exp{\left(\frac{E^2 - C}{2}\right)}
\end{equation}
%
for $E > 7$ this is a pretty good approximation.
